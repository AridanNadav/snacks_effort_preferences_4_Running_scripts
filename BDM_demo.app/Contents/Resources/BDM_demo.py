...
def display_trial(stim,pos):
    file = os.path.join("stim",stim+".bmp")
...
stimlist=["ChocolateParaCookies5.bmp", "ChocolateParaMarir2.bmp", "ChocolateParaMilk3.bmp","ChocolateParaSucariotKoftzot2.bmp", "ClickBalls5.bmp", "ClickBisquit2.bmp"]
