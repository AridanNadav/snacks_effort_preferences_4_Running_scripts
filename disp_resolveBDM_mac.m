% function disp_resolveBDM_mac(subjectID)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Open data from BDM`
fid = fopen([outputPath '/' subjectID '_BDM1.txt']); %tmp(length(tmp)).name
...
while (GetSecs - taim) <= 2,
    ...
    DrawFormattedText(Window,[chosenNumber '' ],1300,850,TextColor);
